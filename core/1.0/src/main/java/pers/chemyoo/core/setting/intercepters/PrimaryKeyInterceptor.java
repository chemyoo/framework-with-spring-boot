	        ...
	        for(ParameterMapping mapping : mappings) {
	        	...
	        	if(IdModel.ID.equals(field)) {
	        		...
	        		if(sid == null) {
	        			...
	        			log.info("auto set {} is : {}", IdModel.ID, key);
	        		}
	        	} else if(IdModel.CREATE_TIME.equalsIgnoreCase(field)) {
        			Object time = DateUtils.getCurrentTime();
        			FieldUtils.writeField(object, field, time, true);
        			log.info("auto set {} is : {}", IdModel.CREATE_TIME, time.toString());
	        		break;
	        	}
	        }
		} 
